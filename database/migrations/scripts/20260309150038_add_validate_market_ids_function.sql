...
-- =============================================================================
-- validate_market_ids
-- Validates that all UUIDs in p_market_ids exist in the corresponding market
-- table for the given market type. Raises an exception listing any IDs that
-- were not found.
-- =============================================================================
...
-- =============================================================================
-- Update ensure_exchange_slate_and_lineups to call validate_market_ids before
-- creating or looking up a slate.
-- =============================================================================
CREATE OR REPLACE FUNCTION ensure_exchange_slate_and_lineups(
    p_market_type market_entity_type,
    p_market_ids UUID[],
...
-- Restore ensure_exchange_slate_and_lineups without validation
CREATE OR REPLACE FUNCTION ensure_exchange_slate_and_lineups(
    p_market_type market_entity_type,
    p_market_ids UUID[],
    p_total_units BIGINT
