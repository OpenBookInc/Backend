...
func (x *EngineMessage) GetSequencedMessageBase() *SequencedMessageBase {
	if x != nil {
		return x.SequencedMessageBase
	}
	return nil
...
type NewOrder_Body struct {
	...
	OrderType     OrderType              `protobuf:"varint,3,opt,name=orderType,proto3,enum=OrderType" json:"orderType,omitempty"`
...
const file_MatchingService_proto_rawDesc = "" +
	...
	"\x11CreateTradeStream\x12/.OpenBook.MatchingServicePackage.GatewayMessage\x1a..OpenBook.MatchingServicePackage.EngineMessage(\x010\x01B\x10Z\x0eOpenBook/protob\x06proto3"
...
var file_MatchingService_proto_goTypes = []any{
	...
	(*SequencedMessageBase)(nil),            // 16: SequencedMessageBase
	(*ResponseBase)(nil),                    // 17: ResponseBase
	(*FallibleBase)(nil),                    // 18: FallibleBase
	(OrderType)(0),                          // 19: OrderType
}
