...
type Game struct {
	...
	ContenderIDA         string    `json:"contender_id_a"`          // Foreign key to teams table (home team)
	ContenderIDB         string    `json:"contender_id_b"`          // Foreign key to teams table (away team)
